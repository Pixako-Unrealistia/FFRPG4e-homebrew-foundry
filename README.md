...
The system has passed static syntax and JSON validation. It still needs a live Foundry v14 load test after being placed in a Foundry `Data/systems` folder.
